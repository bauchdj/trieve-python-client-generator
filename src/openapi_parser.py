...
class OpenAPIParser:
        ...
        for path, methods in self.paths.items():
            for method, details in methods.items():
                ...
                for http_param in operation["parameters"]:
                    self._add_unique(http_params, http_param)
                operations.append(operation)
        headers = [http_param for http_param in http_params if "header" in http_param["in"]]
        openapi_metadata = {
    ...
    def _parse_operation(self, path: str, method: str, details: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _parse_request_body(self, request_body: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "length_nested_json_schemas": length_nested_json_schemas,
        }
...
if __name__ == "__main__":
    ...
    print('Path Operations:', json.dumps(operations, indent=2))
